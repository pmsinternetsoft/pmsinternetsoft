...
import { makeStyles, withStyles, Box,Grid, Typography, TableCell, TableContainer, TableBody, Divider, Table, TableRow, TableHead } from '@material-ui/core';
            ...
            {Activitydata?.map((data) => (
              <TableRow>
                <TableCell>
                  ...
                  >
                    <LoyaltyIcon color="#E19C32" style={{ fontSize: "15px" }} />
                    &nbsp; {data.Event}
                  </Box>
                </TableCell>
                <TableCell>
